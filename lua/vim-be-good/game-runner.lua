...
local games = {
    ...
    indent = function(difficulty, window)
        return IndentRound:new(difficulty, window)
    end,

    -- beforeandafter = function(difficulty, window)
    --     return BeforeAndAfterRound:new(difficulty, window)
    -- end,

    letsmoveit = function(difficulty, window)
        return LetsMoveItRound:new(difficulty, window)
    end,
}
